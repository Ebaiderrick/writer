export function buildSystemPrompt() {
  return `You are an elite Hollywood Screenwriter and Script Doctor.
...
export function buildUserPrompt({ type, action, current, context, instruction }) {
  return `STORY CONTEXT (PREVIOUS BEATS):
${context}
