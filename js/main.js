...
import { bindEvents, renderStudio, applySaveModeButtons, triggerReportDialog } from './events.js?v=20260622a';
import { showAuth, showHome, renderHome, applyToolbarState, applyTheme, applyViewState, showToast } from './ui.js?v=20260622a';
